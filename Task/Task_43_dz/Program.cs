...
double[] Decision(double[,] Values)    // находим x и y.
{
    /*x*/crossPoint[0] = (Values[1, 1] - Values[0, 1]) / (Values[0, 0] - Values[1, 0]);
    /*y*/crossPoint[1] = crossPoint[0] * Values[0, 0] + Values[0, 1];
    return crossPoint;
}
